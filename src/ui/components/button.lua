...
return function(props)
    ...
    return GUI {
        ...
        backgroundColor = props.backgroundColor or { colors.rgbForGraphics(colors.Slate600) },
        hoverColor = props.hoverColor or { colors.rgbForGraphics(colors.Slate500) },
        textColor = props.textColor or { colors.rgbForGraphics(colors.Slate100) },
